<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/i03/0422/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '/i03/0422/' . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/i03/0422/project/config/routes.php';
